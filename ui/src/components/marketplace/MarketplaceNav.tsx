      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              href="/marketplace"
              className="text-sm font-medium text-gray-900 dark:text-white border-b-2 border-blue-600 dark:border-blue-400 pb-1"
            >
              Buy
            </Link>
            <Link
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Favorites Icon */}
            <button className="p-2 text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
